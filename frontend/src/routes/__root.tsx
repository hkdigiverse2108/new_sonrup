  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-4 p-4 bg-red-100 text-red-900 rounded-md text-left text-xs overflow-auto max-h-64">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    ...
    links: [
      { rel: "icon", href: "/favicon.png?v=9", type: "image/png" },
      { rel: "apple-touch-icon", href: "/favicon.png?v=9" },
      { rel: "shortcut icon", href: "/favicon.png?v=9" },
  ...
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-1QGEGNKH5H"></script>
        <script
